...
heart_disease$sex <- ifelse(isTRUE(heart_disease$sex), "Male", "Female") |> factor()
...
heart_disease$fbs <- ifelse(isTRUE(heart_disease$fbs), "Fasting Blood Sugar >120" , "Fasting Blood Sugar <= 120") |> factor()
...
::: fragment
As age increases by 1 year, the odds of experiencing death increases by a factor of 1.054.
:::
