...
- A range of plausible values that may contain the true parameter.
- The "Confidence" part indicates the probability that the method will work in capturing the true mean.
