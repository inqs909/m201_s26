...
image-alt: "A sigmoidal line starting from the bottom to the top. Data points are scattered at 0 and 1 of the y-axis."
execute:
  echo: true
  warning: false
  message: false
...
-   `X1`, `X2`, ..., `Xp`: predictor variables (e.g `age`, `thickness`) found in `DATA`
