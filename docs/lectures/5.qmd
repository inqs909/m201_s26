...
#| code-fold: false
#| echo: false
x <- penguins$flipper_len
y <- penguins$body_mass

# Compute 2D kernel density estimate
kde <- MASS::kde2d(x, y, h = c(38.59,1068.536), n = 25)
...
plot_ly(
  ...
  add_surface(showscale = FALSE, showlegend = FALSE) |>
  layout(
    scene = list(
...
When flipper length increases by 1 mm, the body mass will increase by an average of 50.15 grams.
